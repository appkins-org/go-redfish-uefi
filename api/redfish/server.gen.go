...
func HandlerWithOptions(si ServerInterface, options StdHTTPServerOptions) http.Handler {
	...
	m.HandleFunc("POST "+options.BaseURL+"/redfish/v1/Systems/{ComputerSystemId}/Actions/ComputerSystem.Reset", wrapper.ResetSystem)
	m.HandleFunc("DELETE "+options.BaseURL+"/redfish/v1/Systems/{ComputerSystemId}/Storage/Volumes/{StorageId}", wrapper.DeleteVirtualdisk)
	m.HandleFunc("GET "+options.BaseURL+"/redfish/v1/Systems/{ComputerSystemId}/Storage/{StorageControllerId}/Volumes", wrapper.GetVolumes)
	m.HandleFunc("POST "+options.BaseURL+"/redfish/v1/Systems/{ComputerSystemId}/Storage/{StorageControllerId}/Volumes", wrapper.CreateVirtualDisk)
	m.HandleFunc("GET "+options.BaseURL+"/redfish/v1/Systems/{ComputerSystemId}", wrapper.GetSystem)
	m.HandleFunc("PATCH "+options.BaseURL+"/redfish/v1/Systems/{ComputerSystemId}", wrapper.SetSystem)
